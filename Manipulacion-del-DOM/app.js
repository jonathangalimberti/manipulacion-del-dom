...
// console.log(children);   ---> nos devuelve los nodos hijos 

// const firstChild = parent.firstElementChild; ---> nos devuelve el primer nodo hijo

// console.log(firstChild);

// const lastChild = parent.lastElementChild;
// console.log(lastChild);   ---> nos devuelve el último nodo hijo

// const previousSibling = parent.previousElementSibling;
// console.log(previousSibling);   ---> nos devuelve el nodo hermano anterior

// const nextSibling = parent.nextElementSibling;
// console.log(nextSibling);   ---> nos devuelve el nodo hermano siguiente
